...
# set size of video frame for screen
...
# roz aval
cap = cv.VideoCapture("videos/video_2024-01-18_00-28-18.mp4")

while(True):
    rec, frame = cap.read()
    rec, frame2 = cap.read()
    resized_frame1 = rescale_frame(frame,30)
    resized_frame2 = rescale_frame(frame2,30)
